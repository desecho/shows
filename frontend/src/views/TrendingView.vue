<template>
  <ErrorBoundary context="Trending Shows" fallback-message="Unable to load trending shows">
      ...
      <div v-else class="empty-state">
        <v-row>
          <v-col cols="12" class="text-center">
            <v-icon icon="mdi-television-off" size="64" color="grey" class="mb-4"></v-icon>
            <h3 class="mb-2">No trending shows found</h3>
            <p class="text-body-1 mb-4">We couldn't load trending shows right now. Please try again.</p>
            <v-btn color="primary" variant="elevated" :loading="trendingOperation.isLoading.value" @click="loadShows">
...
const trendingOperation = useApiCall("Load Trending Shows");
