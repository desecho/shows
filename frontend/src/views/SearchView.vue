<template>
  <v-container class="search-container">
    <div class="search-header">
      <h1 class="page-title">Discover Shows</h1>
      <p class="page-subtitle">Search for shows and actors</p>
    </div>
    ...
    <v-row v-if="shows.length > 0">
      <v-col cols="12">
        <div class="results-header">
          ...
          <v-chip color="primary" variant="outlined">{{ shows.length }} found</v-chip>
        </div>
...
useSEO({
  title: "Search Shows",
  description: "Search for shows and actors on Shows. Discover your next favorite show.",
  keywords: ["show search", "TV show search", "actor search", "show database"],
  type: "website",
  url: "/search",
});
...
const searchOperation = useApiCall("Show Search");
...
async function search(): Promise<void> {
  ...
  if (result.success && result.data) {
    ...
    showResults.forEach((show: ShowPreview) => {
      show.hidden = false;
    });
