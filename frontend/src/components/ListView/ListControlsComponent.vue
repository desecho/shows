<template>
  <div class="controls-section">
    <v-row>
      ...
      <v-col cols="12" md="6">
        <div class="control-group">
          ...
          >
            <v-btn value="releaseDate" :size="sortButtonSize">First air date</v-btn>
    ...
    <!-- Filter Controls -->
    <v-row v-if="!isProfileView && currentListId === listToWatchId">
      <v-col cols="12" md="6">
        <div class="control-group">
          <label class="control-label">Filter</label>
          <div style="display: flex; gap: 8px">
            <v-btn-toggle
              :model-value="hideUnreleasedShows"
              density="compact"
              @update:model-value="$emit('update:hideUnreleasedShows', $event ?? false)"
            >
...
const emit = defineEmits<{
  ...
  "update:hideUnreleasedShows": [filter: boolean];
