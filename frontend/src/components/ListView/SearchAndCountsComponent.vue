  ...
  <v-row>
    <v-col cols="6">
      <v-text-field
        ...
        class="mr-5"
        density="compact"
        title="You can search by show title, actor, or writer"
      ...
      <div class="watch-count-container">
        ...
        <div class="watch-count-item watching">
          ...
          <div class="count-info">
            ...
            <span class="count-label">Watching</span>
          </div>
        </div>
...
.watch-count-item.watching:hover .count-icon-wrapper.watching-icon {
